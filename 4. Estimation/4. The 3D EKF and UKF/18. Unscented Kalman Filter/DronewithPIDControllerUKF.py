...
class DronewithPIDUKF(CoaxialCopter,PIDController_with_ff):
    ...
    def PID_controler_with_KF(self, position_sigma, motion_sigma, use_ukf=False):
        use_kf=use_ukf
        ...
        sigma_cov = np.array([[velocity_sigma**2,0.0],
        ...
        for i in range(1,self.z_path.shape[0]-1):
            ...
            mu_bar = EKFfilter.predict(u_bar)
...
class DronewithPIDUKFKnobs(CoaxialCopter,PIDController_with_ff):
    ...
    def PID_controler_with_UKF_knobs(self, k_p,k_d,k_i,mass_err, position_sigma, motion_sigma, use_kf=False):
